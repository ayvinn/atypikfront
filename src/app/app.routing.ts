...
export const routes: Routes = [
    { 
        ...
        component: PagesComponent, children: [
            ...
            { path: 'properties', loadChildren: () => import('./pages/properties/properties.module').then(m => m.PropertiesModule),canActivate: [AuthServiceGuard]  },
        ...
        //    { path: 'faq', loadChildren: () => import('./pages/faq/faq.module').then(m => m.FaqModule) },
            ...
            { path: 'account', loadChildren: () => import('./pages/account/account.module').then(m => m.AccountModule),canActivate: [AuthServiceGuard]  }, 
            { path: 'host/:id', loadChildren: () => import('./pages/host/host.module').then(m => m.HostModule),canActivate: [AuthServiceGuard]  }, 
