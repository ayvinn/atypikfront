...
let PropertiesToolbarComponent = class PropertiesToolbarComponent {
    constructor() {
        ...
        this.sortings = ['Filtrage par Défaut', 'Nouveau', 'Ancien', 'Populaire', 'Prix (Ordre Croissant)', 'Prix (Ordre Décroissant)'];
    }
    ngOnInit() {
